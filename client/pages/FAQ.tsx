...
const faqs: FAQItem[] = [
  {
    ...
    answer: "The Gaussian Plume Model is an industry-standard mathematical model used to estimate the dispersion of air pollutants from a point source. It assumes that the concentration of pollutants follows a Gaussian (normal) distribution both horizontally and vertically as it travels downwind. This model is widely used by environmental agencies and is computationally efficient for regulatory compliance and planning purposes.",
  },
  {
    question: "What weather data does DispersionSim use?",
    answer: "DispersionSim uses real-time meteorological forecasts from the Open-Meteo API, a free and open-source weather data service. For each simulation location and time period, we fetch hourly wind speed, wind direction, temperature, and cloud cover data. This ensures your simulations are based on current and predicted atmospheric conditions.",
  },
  {
    question: "What is the accuracy of the simulations?",
    answer: "The accuracy of DispersionSim results depends on several factors: the quality of input parameters, the accuracy of meteorological data, and the applicability of the Gaussian plume model to your specific conditions. For regulatory compliance, consult local environmental agencies. DispersionSim is ideal for educational purposes, preliminary assessment, and general understanding of pollutant dispersion patterns.",
  },
  {
    question: "Can I simulate multiple pollutants simultaneously?",
    answer: "Currently, DispersionSim simulates one pollutant type per simulation (PM2.5, PM10, or other particulates). If you need to model multiple pollutants, you can run separate simulations for each and compare results. This approach also allows you to evaluate the specific behavior of each pollutant under identical conditions.",
  },
  {
    question: "What is the maximum simulation duration?",
    answer: "DispersionSim provides simulations for up to 48 hours in the future. This is limited by the availability of accurate meteorological forecast data. The 48-hour window provides sufficient time to observe how dispersion patterns change as weather conditions evolve, making it ideal for short-term air quality assessment and planning.",
  },
  {
    question: "How do I choose the right stability class?",
    answer: "Atmospheric stability class depends on time of day and cloud cover: Class A (very unstable) occurs during day with clear skies, Class B (unstable) during day with some clouds, Class D (neutral) during night or overcast conditions, and Class E-F (stable) during clear nights. Each class affects how much the plume spreads vertically. For best results, research atmospheric stability classifications for your region.",
  },
  {
    question: "Can I export the simulation results?",
    answer: "Yes! DispersionSim allows you to download results as CSV files directly from the Details tab. The exported data includes hourly concentrations, wind speed, direction, and other relevant metrics. You can then use this data in spreadsheets, statistical software, or other analysis tools.",
  },
  {
    question: "Is DispersionSim free to use?",
    answer: "Yes, DispersionSim is completely free to use. There are no subscription fees, no registration required, and no API usage limits. We're committed to making air quality modeling accessible to everyone. The project uses open-source software and free weather data from Open-Meteo.",
  },
  {
    question: "What are the system requirements?",
    answer: "DispersionSim is web-based and works on any modern browser (Chrome, Firefox, Safari, Edge). No installation is required. For the best experience, use a desktop or tablet with a screen size of at least 768px wide. Mobile phones are supported but may provide a compressed interface.",
  },
  {
    question: "Can I use DispersionSim for regulatory compliance?",
    answer: "DispersionSim is designed as an educational and preliminary assessment tool. While it uses industry-standard models, regulatory compliance often requires specialized software and EPA-approved models. Always consult your local environmental regulatory agency for compliance requirements. DispersionSim is excellent for understanding fundamentals and initial impact assessment.",
  },
  {
    question: "How do I report a bug or suggest a feature?",
    answer: "We appreciate your feedback! Please visit our Contact page to report issues or suggest features. You can also check our GitHub repository for the latest updates and contribute to the project if you're interested in development.",
  },
  {
    question: "Is my data private and secure?",
    answer: "DispersionSim simulations are performed on your browser and our secure servers. We don't store simulation results or personal data beyond the duration of your session. Weather data is fetched from Open-Meteo's public API. For detailed information about data handling, please review our Privacy Policy.",
  },
];
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Our support team is here to help. Reach out with your question or concern.
            </p>
