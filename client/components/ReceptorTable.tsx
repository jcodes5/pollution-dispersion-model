...
import { exportToCSV, getGridAverage, getGridStats } from "@/utils/csv-export";
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 pt-4 border-t border-border">
          ...
          <div className="p-3 bg-muted rounded">
            ...
            <p className="text-2xl font-bold text-foreground mt-1">
              {getGridAverage(results[peakHour].concentrationGrid).toFixed(4)}
            </p>
            <p className="text-xs text-muted-foreground">at peak hour</p>
          </div>
        </div>
      </div>
    </Card>
